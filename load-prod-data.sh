...
# 4. Load fixtures using our PHP script
print_status "Loading fixtures (roles, permissions, and test users)..."
if sudo docker compose --env-file "$ENV_FILE" -f "$DOCKER_COMPOSE_FILE" exec -T app php load-fixtures.php; then
