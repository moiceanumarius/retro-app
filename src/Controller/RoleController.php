...
final class RoleController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        // Use RoleService to get all roles
        $allRoles = $this->roleService->getAllRoles();
        
        // Use RoleHierarchyService to filter roles based on hierarchy
        $roles = $this->roleHierarchyService->filterRolesByHierarchy($allRoles, $currentUser);
        
        // Use RoleService to get users from organization
        $users = $this->roleService->getUsersFromOrganization($currentUser);
        ...
        // Use RoleService to get role counts
        $roleCounts = $this->roleService->getRoleCountsForOrganization($userOrganization, $roles);
    ...
    public function assignRole(Request $request): Response
    {
        ...
        $userRole = $this->roleService->assignRoleToUser($user, $role, $this->getUser());
    ...
    public function removeRole(Request $request, int $userRoleId): Response
    {
        ...
        // Use RoleService to get user role
        $userRole = $this->roleService->getUserRoleById($userRoleId);
        ...
        // Use RoleService to remove role
        $this->roleService->removeUserRole($userRole);
    ...
    public function getRolesData(Request $request): JsonResponse
    {
        ...
        $currentUser = $this->getUser();
        $organization = $this->organizationService->getUserOrganization($currentUser);
        ...
        // Use RoleHierarchyService to apply role hierarchy filtering
        $this->roleHierarchyService->applyRoleHierarchyFilter($qb, $currentUser);
