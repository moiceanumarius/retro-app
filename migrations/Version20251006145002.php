...
final class Version20251006145002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
             ...
             AND INDEX_NAME = "uniq_admin_user_email") > 0,
        ...
        $this->addSql('SET @sql = (SELECT IF(
            ...
            "ALTER TABLE timer_likes DROP FOREIGN KEY `FK_TIMER_LIKES_RETROSPECTIVE`",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            ...
            "ALTER TABLE timer_likes DROP FOREIGN KEY `FK_TIMER_LIKES_USER`",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
    ...
    public function down(Schema $schema): void
    {
        ...
        // Rename index back only if it exists
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
             WHERE TABLE_SCHEMA = DATABASE() 
             AND TABLE_NAME = "admin_user" 
             AND INDEX_NAME = "uniq_ad8a54a9e7927c74") > 0,
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "organization_members" 
             AND CONSTRAINT_NAME = "FK_88725ABC32C8A3DE") > 0,
            "ALTER TABLE organization_members DROP FOREIGN KEY FK_88725ABC32C8A3DE",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "organization_members" 
             AND CONSTRAINT_NAME = "FK_88725ABCA76ED395") > 0,
            "ALTER TABLE organization_members DROP FOREIGN KEY FK_88725ABCA76ED395",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "organization_members" 
             AND CONSTRAINT_NAME = "FK_88725ABCA7B4A7E3") > 0,
            "ALTER TABLE organization_members DROP FOREIGN KEY FK_88725ABCA7B4A7E3",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "organizations" 
             AND CONSTRAINT_NAME = "FK_427C1C7F7E3C61F9") > 0,
            "ALTER TABLE organizations DROP FOREIGN KEY FK_427C1C7F7E3C61F9",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "team_invitation_used_by" 
             AND CONSTRAINT_NAME = "FK_4B8283E0D63F5F61") > 0,
            "ALTER TABLE team_invitation_used_by DROP FOREIGN KEY FK_4B8283E0D63F5F61",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "team_invitation_used_by" 
             AND CONSTRAINT_NAME = "FK_4B8283E0A76ED395") > 0,
            "ALTER TABLE team_invitation_used_by DROP FOREIGN KEY FK_4B8283E0A76ED395",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             WHERE TABLE_SCHEMA = DATABASE() 
             AND TABLE_NAME = "timer_likes" 
             AND CONSTRAINT_NAME = "FK_346EB54BA76ED395") > 0,
            "ALTER TABLE timer_likes DROP FOREIGN KEY FK_346EB54BA76ED395",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             WHERE TABLE_SCHEMA = DATABASE() 
             AND TABLE_NAME = "timer_likes" 
             AND CONSTRAINT_NAME = "FK_346EB54BBBC656A0") > 0,
            "ALTER TABLE timer_likes DROP FOREIGN KEY FK_346EB54BBBC656A0",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        // Add foreign keys back only if they don't exist
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             WHERE TABLE_SCHEMA = DATABASE() 
             AND TABLE_NAME = "timer_likes" 
             AND CONSTRAINT_NAME = "FK_TIMER_LIKES_RETROSPECTIVE") = 0,
            "ALTER TABLE timer_likes ADD CONSTRAINT `FK_TIMER_LIKES_RETROSPECTIVE` FOREIGN KEY (retrospective_id) REFERENCES retrospective (id) ON UPDATE NO ACTION ON DELETE CASCADE",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE 
             ...
             AND TABLE_NAME = "timer_likes" 
             AND CONSTRAINT_NAME = "FK_TIMER_LIKES_USER") = 0,
            "ALTER TABLE timer_likes ADD CONSTRAINT `FK_TIMER_LIKES_USER` FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
             WHERE TABLE_SCHEMA = DATABASE() 
             AND TABLE_NAME = "timer_likes" 
             AND INDEX_NAME = "idx_346eb54bbbc656a0") > 0,
            "ALTER TABLE timer_likes RENAME INDEX idx_346eb54bbbc656a0 TO IDX_TIMER_LIKES_RETROSPECTIVE",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
        ...
        $this->addSql('SET @sql = (SELECT IF(
            (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
             WHERE TABLE_SCHEMA = DATABASE() 
             AND TABLE_NAME = "timer_likes" 
             AND INDEX_NAME = "idx_346eb54ba76ed395") > 0,
            "ALTER TABLE timer_likes RENAME INDEX idx_346eb54ba76ed395 TO IDX_TIMER_LIKES_USER",
            "SELECT 1"
        ));
        PREPARE stmt FROM @sql;
        EXECUTE stmt;
